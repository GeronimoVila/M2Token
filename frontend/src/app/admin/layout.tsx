  ...
  const SidebarContent = (
    <div className="flex flex-col h-full bg-brand-dark text-white">
      ...
      <nav className="flex-1 overflow-y-auto px-4 py-8 space-y-2">
        <div className="text-xs font-semibold text-brand-light/40 uppercase tracking-wider mb-4 px-2">Gestión Global</div>
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="flex-1 md:ml-64 flex flex-col min-h-screen">
        <Header />
        <main className="flex-1 p-6 sm:p-8 pt-20 md:pt-8">
          {children}
        </main>
      </div>
    </div>
