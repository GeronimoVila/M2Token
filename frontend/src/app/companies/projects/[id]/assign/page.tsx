                    ...
                    <Card key={item.assignmentId || Math.random()} className="border-l-4 border-l-brand-blue shadow-sm hover:shadow-md transition-all">
                      <CardContent className="p-4">
                          <div className="flex justify-between items-start mb-2">
                              <h4 className="font-bold text-gray-800">{item.provider?.name || 'Proveedor'}</h4>
                          ...
                          <div className="text-sm text-gray-500 space-y-1">
                              <div className="flex items-center gap-2"><Mail className="h-3 w-3"/> {item.provider?.email || 'N/A'}</div>
